...
public class RegistroGareSem {
    ...
    public int addGara(Socket enteSocket, Richiesta2 richiesta) throws InterruptedException {
        lock.acquire();
        int idGara = COUNTER++;
    ...
    public void aggiungiOfferta (Offerta2 offerta) throws InterruptedException {
        lock.acquire();
